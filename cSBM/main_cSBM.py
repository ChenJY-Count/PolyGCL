...
parser.add_argument(
    "--dataname", type=str, default="cSBM_phi_-0.75", help="Name of dataset."
)
...
parser.add_argument(
    "--lr3", type=float, default=0.01, help="Learning rate of alpha."
)
parser.add_argument(
...
if __name__ == "__main__":
    ...
    # Step 2: Create model =================================================================== #
    model = Model(in_dim=n_feat, out_dim=args.hid_dim, K=args.K, dprate=args.dprate, dropout=args.dropout, is_bns=args.is_bns, act_fn=args.act_fn, init_low=args.init_low, init_high=args.init_high, val_range=args.val_range)
    ...
    optimizer = torch.optim.Adam([
                                  ...
                                  {'params': model.alpha, 'weight_decay': args.wd, 'lr': args.lr3},
                                  ])
